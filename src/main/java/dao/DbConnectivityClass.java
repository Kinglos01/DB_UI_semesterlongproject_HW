...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311berio.mysql.database.azure.com/";//update this server name
        final static String DB_URL = "jdbc:mysql://csc311berio.mysql.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "berica";// update this username
